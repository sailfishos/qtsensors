...
%package plugin-sensorfw-config
Summary:    sensorfw sensors plugin default configuration
Group:      Qt/Qt
Requires:   %{name} = %{version}-%{release}

%description plugin-sensorfw-config
This package contains a configuration file enabling use of the sensors plugin
