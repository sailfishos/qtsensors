...
char const * const VBoxOrientationSensor::id("vbox.orientation");

VBoxOrientationSensor::VBoxOrientationSensor(QSensor *sensor)
...
void VBoxOrientationSensor::start()
{
...
void VBoxOrientationSensor::stop()
{
    accelerometer->stop();
}

bool VBoxOrientationSensor::filter(QAccelerometerReading *reading)
{
