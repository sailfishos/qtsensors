...
char const * const VBoxRotationSensor::id("vbox.rotation");

VBoxRotationSensor::VBoxRotationSensor(QSensor *sensor)
...
void VBoxRotationSensor::stop()
{
    accelerometer->stop();
}

bool VBoxRotationSensor::filter(QSensorReading *reading)
{
